...
export const VENDORS: Vendor[] = [
  { id: "v-1", name: "Diamond Cement Ghana Ltd.", category: "cement", region: "Greater Accra", city: "Tema",
    rating: 4.8, reviewCount: 1240, jobsCompleted: 8400, yearsActive: 24,
    gra_tin: "C0001824011", momoMerchantId: "DCG2014", licensed: true, letterheadVerified: true,
    bio: "Largest cement producer in Ghana. 50kg bags, bulk, and ready-mix.",
    productLines: ["Diamond Super Strong 32.5", "Diamond Heavy Duty 42.5", "Diamond Bulk"],
    priceBand: "mid", responseHours: 4, lastVerifiedAt: minus(2) },
  { id: "v-2", name: "Aluworks Limited", category: "aluminum", region: "Greater Accra", city: "Tema",
    rating: 4.7, reviewCount: 412, jobsCompleted: 1820, yearsActive: 38,
    gra_tin: "C0000882412", momoMerchantId: "ALWK1987", licensed: true, letterheadVerified: true,
    bio: "Aluminum coil, sheet, and roofing systems. GSE-listed.",
    productLines: ["Long-span roofing", "Step-tile profile", "Coil"],
    priceBand: "mid", responseHours: 8, lastVerifiedAt: minus(5) },
  { id: "v-3", name: "B5 Plus Iron & Steel", category: "rebar", region: "Greater Accra", city: "Tema",
    rating: 4.6, reviewCount: 612, jobsCompleted: 3120, yearsActive: 21,
    gra_tin: "C0001144122", momoMerchantId: "B5P2010", licensed: true, letterheadVerified: true,
    bio: "TMT rebar in Y8 through Y32. Mill-tested + branded.",
    productLines: ["Y12 rebar", "Y16 rebar", "Y20 rebar", "BRC mesh"],
    priceBand: "mid", responseHours: 6, lastVerifiedAt: minus(3) },
  { id: "v-4", name: "GHACEM Ghana", category: "cement", region: "Greater Accra", city: "Tema",
    rating: 4.7, reviewCount: 980, jobsCompleted: 7100, yearsActive: 56,
    gra_tin: "C0000201184", momoMerchantId: "GHA1968", licensed: true, letterheadVerified: true,
    bio: "Ghana's longest-running cement producer. 32.5R / 42.5R / Suprema.",
    productLines: ["GHACEM 32.5R", "GHACEM 42.5R", "Suprema"],
    priceBand: "mid", responseHours: 4, lastVerifiedAt: minus(1) },
  { id: "v-5", name: "Kumasi Block Industries", category: "blocks", region: "Ashanti", city: "Kumasi",
    rating: 4.4, reviewCount: 188, jobsCompleted: 940, yearsActive: 14,
    gra_tin: "C0011002288", momoMerchantId: "KBI2011", licensed: true, letterheadVerified: true,
    bio: "Sandcrete blocks 5\", 6\", 8\". Delivered Kumasi metro.",
    productLines: ["5\" sandcrete", "6\" sandcrete", "8\" sandcrete"],
    priceBand: "budget", responseHours: 12, lastVerifiedAt: minus(7) },
  { id: "v-6", name: "Sun Tiles Ghana", category: "tiles", region: "Greater Accra", city: "Accra",
    rating: 4.5, reviewCount: 322, jobsCompleted: 1400, yearsActive: 12,
    gra_tin: "C0014411023", momoMerchantId: "SUN2013", licensed: true, letterheadVerified: true,
    bio: "Spanish and Turkish floor/wall tile importer. Bulk + retail.",
    productLines: ["60×60 porcelain", "30×60 ceramic", "20×60 wall"],
    priceBand: "mid", responseHours: 18, lastVerifiedAt: minus(10) },
  { id: "v-7", name: "Coral Paints Ltd.", category: "paint", region: "Greater Accra", city: "Spintex",
    rating: 4.6, reviewCount: 488, jobsCompleted: 2200, yearsActive: 31,
    gra_tin: "C0000844122", momoMerchantId: "CRL1993", licensed: true, letterheadVerified: true,
    bio: "Emulsion, gloss, weather-shield. Made-in-Ghana.",
    productLines: ["Premium emulsion", "Weather-shield", "Wood gloss"],
    priceBand: "premium", responseHours: 24, lastVerifiedAt: minus(8) },
  { id: "v-8", name: "Volta Timber & Joinery", category: "timber", region: "Volta", city: "Ho",
    rating: 4.3, reviewCount: 102, jobsCompleted: 480, yearsActive: 19,
    gra_tin: "C0014821011", momoMerchantId: "VTJ2008", licensed: true, letterheadVerified: true,
    bio: "Wawa, odum, mahogany. Kiln-dried + treated.",
    productLines: ["Odum 2×4", "Wawa 2×4", "Mahogany planks"],
    priceBand: "mid", responseHours: 36, lastVerifiedAt: minus(12) },
  { id: "v-9", name: "Eastern Plumbing Supplies", category: "plumbing", region: "Eastern", city: "Koforidua",
    rating: 4.2, reviewCount: 96, jobsCompleted: 388, yearsActive: 11,
    gra_tin: "C0019402188", momoMerchantId: "EPS2014", licensed: true, letterheadVerified: false,
    bio: "PVC, PPR, brass fittings. Koforidua + greater Eastern.",
    productLines: ["PPR 20-110mm", "PVC drain", "Brass valves"],
    priceBand: "budget", responseHours: 14, lastVerifiedAt: minus(20) },
  { id: "v-10", name: "Kasoa Hardware Hub", category: "hardware", region: "Central", city: "Kasoa",
    rating: 4.4, reviewCount: 144, jobsCompleted: 720, yearsActive: 9,
    gra_tin: "C0020884111", momoMerchantId: "KHH2016", licensed: true, letterheadVerified: true,
    bio: "Nails, hinges, locks, fasteners. Kasoa one-stop.",
    productLines: ["Nails (various)", "Door locks", "Hinges", "Fasteners"],
    priceBand: "budget", responseHours: 6, lastVerifiedAt: minus(4) },
];

export const PRODUCTS: Product[] = [
  { id: "pr-1", vendorId: "v-1", name: "Diamond Super Strong 32.5 (50kg bag)", unit: "bag", priceGHS: 105, stockLevel: "high", category: "cement", imageColor: "#9aa0b0", description: "Standard portland cement, suitable for general construction.", deliveryDays: 1, minOrder: 10 },
  { id: "pr-2", vendorId: "v-1", name: "Diamond Heavy Duty 42.5 (50kg bag)", unit: "bag", priceGHS: 118, stockLevel: "high", category: "cement", imageColor: "#9aa0b0", description: "Higher early strength, ideal for structural work.", deliveryDays: 1, minOrder: 10 },
  { id: "pr-3", vendorId: "v-4", name: "GHACEM 32.5R (50kg bag)", unit: "bag", priceGHS: 103, stockLevel: "high", category: "cement", imageColor: "#9aa0b0", description: "Reliable general-purpose cement.", deliveryDays: 1, minOrder: 10 },
  { id: "pr-4", vendorId: "v-3", name: "Y12 TMT Rebar (12m length)", unit: "rod", priceGHS: 165, stockLevel: "high", category: "rebar", imageColor: "#71717a", description: "Mill-tested Y12 thermomechanically treated rebar.", deliveryDays: 2, minOrder: 20 },
  { id: "pr-5", vendorId: "v-3", name: "Y16 TMT Rebar (12m length)", unit: "rod", priceGHS: 285, stockLevel: "high", category: "rebar", imageColor: "#71717a", description: "Y16 rebar for structural beams and columns.", deliveryDays: 2, minOrder: 20 },
  { id: "pr-6", vendorId: "v-2", name: "Long-span aluminum roofing (per sqm)", unit: "sqm", priceGHS: 95, stockLevel: "high", category: "aluminum", imageColor: "#a8a29e", description: "0.45mm aluminum sheet, custom cut, 0.5mm available.", deliveryDays: 3, minOrder: 30 },
  { id: "pr-7", vendorId: "v-5", name: "6\" Sandcrete Block (each)", unit: "block", priceGHS: 5.5, stockLevel: "high", category: "blocks", imageColor: "#a3a3a3", description: "Standard 6-inch hollow sandcrete block.", deliveryDays: 1, minOrder: 200 },
  { id: "pr-8", vendorId: "v-6", name: "60×60 Porcelain Floor Tile (sqm)", unit: "sqm", priceGHS: 88, stockLevel: "medium", category: "tiles", imageColor: "#d4d4d8", description: "Italian-style porcelain, anti-slip rating R10.", deliveryDays: 5, minOrder: 10 },
  { id: "pr-9", vendorId: "v-7", name: "Coral Premium Emulsion (20L)", unit: "bucket", priceGHS: 380, stockLevel: "high", category: "paint", imageColor: "#fafafa", description: "Wash-and-wear interior emulsion. White + tinting available.", deliveryDays: 2, minOrder: 1 },
  { id: "pr-10", vendorId: "v-8", name: "Odum 2×4 (12ft)", unit: "piece", priceGHS: 78, stockLevel: "high", category: "timber", imageColor: "#92400e", description: "Kiln-dried odum for roofing trusses.", deliveryDays: 3, minOrder: 20 },
];
...
export const DISPUTES: Dispute[] = [
  {
    id: "d-1",
    projectId: "east-legon-plot",
    raisedBy: "Nana Yaw Boateng",
    raisedAgainst: "Nii Agyemang (vendor) & Yawson Developments (encroacher)",
    amountGHS: 1_250_000,
    type: "title",
    stage: "mediation",
    openedAt: minus(11),
    lastUpdated: minus(2),
    summary: "Title overlap claim on 0.8-acre easter portion plus active encroachment by 3rd-party developer.",
    arbitratorAssigned: "Ghana ADR Centre — Hon. K. Ofori",
    evidenceCount: 14,
    hearings: [
      { ts: minus(9), mode: "video", notes: "Initial scoping call. All three parties confirmed willingness to mediate." },
      { ts: minus(5), mode: "in-person", notes: "Site visit by mediator at the parcel. Encroacher acknowledged building error." },
      { ts: minus(2), mode: "written", notes: "Round 1 settlement proposal exchanged. Awaiting response from Nii Agyemang." },
    ],
  },
  {
    id: "d-2",
    projectId: "kasoa-4bed",
    raisedBy: "Akosua Mensah",
    raisedAgainst: "Kwame Mensah (manager)",
    amountGHS: 95_000,
    type: "documentation",
    stage: "negotiation",
    openedAt: minus(4),
    lastUpdated: minus(1),
    summary: "Cement receipt forensics + off-site photo cluster. Manager disputes the AI verdict; offered to provide originals.",
    evidenceCount: 5,
    hearings: [
      { ts: minus(3), mode: "video", notes: "Owner + manager + trustee call. Manager committed to providing original receipts within 7 days." },
    ],
  },
  {
    id: "d-3",
    projectId: "kumasi-shop",
    raisedBy: "Esi Forson",
    raisedAgainst: "Auntie Grace Forson",
    amountGHS: 12_400,
    type: "documentation",
    stage: "resolved",
    openedAt: minus(20),
    lastUpdated: minus(14),
    summary: "Duplicate rent-top-up receipt. Resolved with Auntie Grace agreeing to refund and route all future rent through escrow.",
    evidenceCount: 4,
    hearings: [
      { ts: minus(18), mode: "video", notes: "Family-mediated call." },
      { ts: minus(14), mode: "written", notes: "Refund processed; agreement signed." },
    ],
    resolution: {
      ts: minus(14),
      outcome: "in-favour-claimant",
      awardGHS: 12_400,
      note: "Refund processed in full. Forward rent to escrow with landlord direct.",
    },
  },
];
